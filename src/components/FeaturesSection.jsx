      ...
      <div className="min-h-screen flex items-center px-6 md:px-16 lg:px-24 py-24 border-b border-neutral-900">
        <div className="max-w-7xl w-full mx-auto flex justify-end">
          <div className="w-full md:w-7/12 lg:w-5/12 flex flex-col text-right">
            ...
            >
              Formulated to help you reach your prime. Packed with BCAAs, B
              Vitamins, Antioxidants, and essential electrolytes — hydration
              without compromise.
            </motion.p>
            ...
            >
              {[
                ...
                <div key={stat} className="text-right">
                  ...
                  <p className="font-inter text-[10px] tracking-[0.3em] text-neutral-600 uppercase">
                    {label}
                  </p>
                </div>
              ))}
      ...
      <div className="min-h-screen flex items-center px-6 md:px-16 lg:px-24 py-24">
        <div className="max-w-7xl w-full mx-auto flex justify-start">
          <div className="w-full md:w-7/12 lg:w-5/12 flex flex-col text-left">
            ...
            >
              Built on a 10% coconut water base. An unbeatable, radically
              refreshing taste engineered for peak performance.
            </motion.p>

            {/* Ingredient callouts */}
            <motion.div style={{ y: f2TextY }} className="flex flex-col gap-4">
              {[
                ...
                <div
                  key={value}
                  className="flex items-baseline gap-4 border-b border-neutral-900 pb-4"
                >
                  <span className="font-anton text-3xl text-white">
                    {value}
                  </span>
                  <span className="font-inter text-xs tracking-[0.3em] text-neutral-500 uppercase">
                    {desc}
                  </span>
                </div>
              ))}
